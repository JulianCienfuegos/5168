...
""" The definitions of the p functions use fractions. Somehow, the 
fractions are invalidating the calculations. I dont know why!
WEIRD
"""
...
# Test Functions.
p1  = lambda x: x*(1 - x)
p2  = lambda x: x*(1 - x)*(1/2.0 - x)
p3  = lambda x: x*(1 - x)*(1/3.0 - x)*(2/3.0 - x)
dp1 = lambda x: 1 - 2*x
dp2 = lambda x: 3*x**2 - 3*x + 1/2
dp3 = lambda x: 2.0/9 - 22*x/9.0 + 6*x**2 - 4*x**3
